...
% Toggle anonymization: set \anonymoustrue for NDSS, \anonymousfalse for arXiv
\newif\ifanonymous
\anonymoustrue % default: anonymous (NDSS)
...
\else
  ...
  \newcommand{\anonrepo}{\url{https://github.com/REDACTED/kcov-dataflow}}
  \newcommand{\authorblock}{%
    \author{%
      First Author\thanks{Affiliation} \and
      Second Author\thanks{Affiliation}
    }%
  }
\fi
...
\newcommand{\traceargs}{\texttt{dataflow-args}\xspace}
\newcommand{\traceret}{\texttt{dataflow-ret}\xspace}
